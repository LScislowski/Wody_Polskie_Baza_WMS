...
FORM_CLASS, _ = uic.loadUiType(os.path.join(
    os.path.dirname(__file__), 'Wody_Polskie_WMS_dialog_base.ui'))


class WodyPolskieWMSDialog(QtWidgets.QDialog, FORM_CLASS):
    def __init__(self, parent=None):
        """Constructor."""
        super(WodyPolskieWMSDialog, self).__init__(parent)
